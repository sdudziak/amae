...
if (file_exists($root_dir . '/.env')) {
    ...
    // Do not require WP_HOME / WP_SITEURL here — allow dynamic detection below
    // Require DB credentials unless DATABASE_URL is provided
    if (!env('DATABASE_URL')) {
...
if (!defined('PROTECTED_PATH')) {
    Config::define('PROTECTED_PATH', env('PROTECTED_PATH') ?: '/var/www/protected');
}
